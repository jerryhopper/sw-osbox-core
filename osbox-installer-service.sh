...
osbox_listener_service(){
    ...
    if [ -f /etc/systemd/system/osbox-listener.service ] ; then
        rm -f /etc/systemd/system/osbox-listener.service
    fi
    ln -s /usr/local/osbox/lib/systemd/osbox-listener-service /etc/systemd/system/osbox-listener.service
